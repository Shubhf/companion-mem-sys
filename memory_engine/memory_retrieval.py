...
QUERY_ATTRIBUTE_MAP = {
    ...
    "lambai": ["height", "lambai", "kad"],
    "kad": ["height", "lambai", "kad"],
    "fitness": ["weight", "height", "gym", "exercise", "fitness"],
    "body": ["weight", "height", "body_weight", "health"],
    "score": ["score", "marks", "grade", "cgpa", "percentage"],
    "marks": ["score", "marks", "grade", "cgpa"],
    "cgpa": ["score", "marks", "grade", "cgpa"],
    "rank": ["rank", "position", "score"],
